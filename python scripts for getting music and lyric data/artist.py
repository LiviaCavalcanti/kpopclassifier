...
artist_names = ["BTS", "BLACKPINK", "Twice", "EXO", "Got7", "Red Velvet", "Girls' Generation", "iKON", "MONSTA X", "BIGBANG", "Shawn Mendes", "Billie Eilish", "Ariana Grande", "Khalid", "Halsey", "Rihanna", "Bruno Mars", "Beyonce", "Lady Gaga", "Katy Perry"]
...
data.to_csv('../data/artists_name_and_followers.csv')